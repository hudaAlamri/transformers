...
from transformers import DataCollatorForLanguageModelingAVSD
...
def get_dataset(args: DataTrainingArguments, tokenizer: PreTrainedTokenizer, evaluate=False):
    ...
    if args.line_by_line:
        return LineByLineTextDatasetAVSD(tokenizer=tokenizer, file_path=file_path, block_size=args.block_size)
    else:
        return TextDataset(
...
def main():
    ...
    if avsd_eval:
        ...
        json.dump(results, open('/home/halamri/summer2020/avsd-transofrmers/mlmAVSD/bertPredicitonResults_June15_corrected.txt', 'w'))
